...
export default async function TokenWallet() {
    ...
    return (
        <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-40 bg-gradient-to-r from-green-500 to-green-600 text-white p-4 rounded-xl shadow-lg border border-green-400 min-w-[200px] backdrop-blur-sm">
